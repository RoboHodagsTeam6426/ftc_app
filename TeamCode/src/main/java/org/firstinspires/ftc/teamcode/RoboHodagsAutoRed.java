...
@Autonomous(name = "RoboHodagsAutoRed")
...
public class RoboHodagsAutoRed extends LinearOpMode {
    ...
    public void runOpMode() throws  InterruptedException {
        ...
        rangeBackwardU(120, 0, 1);
        waitFunct(500);
        turnAbsolute(-90);
        waitFunct(500);
        rangeBackwardU(15, -90, 1);
        waitFunct(500);
        turnAbsolute(0);
        waitFunct(500);
        rangeBackwardU(230, 0, 1);
        waitFunct(500);
        turnAbsolute(-135);
